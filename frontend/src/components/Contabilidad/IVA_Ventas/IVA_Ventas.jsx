          ...
          <div className="mov-card__headLeft">
            <div className="title-mov">
              ...
              <div className="mov-card__hint">
                Mostrando <b>{registrosIniciales.length}</b> registros de IVA ventas
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="mov-gridBody mov-gridBody--relative">
            {registrosIniciales.length === 0 ? (
              <div className="cc-emptyState contabilidad-emptyState">
                ...
                <div className="cc-emptyText">No hay registros de IVA ventas cargados todavía.</div>
              </div>
            ) : (
              registrosIniciales.map((item) => (
                ...
                >
                  ...
                  <div className="mov-gridCell" role="cell">{item.cliente}</div>
